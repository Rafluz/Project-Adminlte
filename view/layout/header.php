                ...
                <ul class="navbar-nav ms-auto"> <!--begin::Navbar Search-->
                        ...
                        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-end"> <a href="#"
                                ...
                                <div class="d-flex">
                                    <div class="flex-shrink-0"> <img
                                            src="http://localhost:8080/xampp/native/assets/adminlte/assets/img/user1-128x128.jpg"
                    ...
                    <li class="nav-item dropdown user-menu"> <a href="#" class="nav-link dropdown-toggle"
                            data-bs-toggle="dropdown"> <img
                                src="http://localhost:8080/xampp/native/assets/adminlte/assets/img/user2-160x160.jpg"
                                class="user-image rounded-circle shadow" alt="User Image"> <span
                                class="d-none d-md-inline"><?php echo $_SESSION['user']; ?></span> </a>
                        <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-end"> <!--begin::User Image-->
                            <li class="user-header text-bg-primary"> <img
                                    src="../assets/adminlte/assets/img/user2-160x160.jpg" class="rounded-circle shadow"
                                    alt="User Image">
                                <p>
