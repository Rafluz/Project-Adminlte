<aside class="app-sidebar bg-body-secondary shadow" data-bs-theme="dark"> <!--begin::Sidebar Brand-->
    <div class="sidebar-brand"> <!--begin::Brand Link--> <a href="./index.html" class="brand-link">
            <!--begin::Brand Image--> <img src="../../assets/adminlte/assets/img/AdminLTELogo.png" alt="AdminLTE Logo"
    ...
    <div class="sidebar-wrapper">
        <nav class="mt-2"> <!--begin::Sidebar Menu-->
            <ul class="nav sidebar-menu flex-column" data-lte-toggle="treeview" role="menu" data-accordion="false">
                ...
                <li class="nav-item">
                    <a href="?page=tambah_menu" class="nav-link">
                        <i class="nav-icon bi bi-palette"></i>
                        <p>Form Tambah Menu</p>
                    </a>
                </li>
                <li class="nav-item"> <a href="http://localhost:8080/xampp/native/view/page/auth/login.php"
                        class="nav-link"> <i class="nav-icon bi bi-box-arrow-in-right"></i>
                        <p>Logout</p>
                    </a> </li>
            </ul> <!--end::Sidebar Menu-->
        </nav>
